...
public class PermitPage extends AppCompatActivity {
    ...
    private void submitAttendance() {
        ...
        String url = "http://192.168.56.1/wmpbrot/android2.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(PermitPage.this, "Attendance submitted successfully", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PermitPage.this, "Error submitting attendance", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
        ...
        Intent intent = new Intent(PermitPage.this, ListHistory.class);
